  ...
  return (
    <div className="p-5 max-w-4xl mx-auto font-sans leading-relaxed">
      ...
      <ul className="list-disc list-inside mb-8">
        ...
        <li><strong>Website</strong> refers to Tour Planer, accessible from <a href="https://connecttrip.in/" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">https://connecttrip.in/</a></li>
      ...
      <ul className="list-disc list-inside mb-8">
        ...
        <li>email: <a href="mailto:connecttripindia@gmail.com" className="text-blue-500 underline">connecttripindia@gmail.com</a></li>
